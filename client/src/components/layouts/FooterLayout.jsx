          ...
          <div className="container-fluid p-4">
            <div className="row mt-4">
              <div className="col-lg-8 col-md-12 mb-4 mb-md-0">
                ...
                <p>
                  Welcome to Myan San, your trusted partner in travel ticket
                  booking. Established in 2010, Myan San has been dedicated to
                  providing exceptional travel experiences to our customers.
                  Whether you are planning a family vacation, a business trip,
                  or a solo adventure, we are here to make your journey seamless
                  and enjoyable.
                </p>
              </div>
