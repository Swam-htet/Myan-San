...
import useGetStaffByID from "@/libs/hooks/useGetStaffByID";

const StaffEditForm = ({id, onSubmit, modelHandler}) => {
    const [data, setData] = useState();

    const GetStaffDetail = useGetStaffByID(id);

    useEffect(() => {
        setData(GetStaffDetail.data);
    }, [GetStaffDetail.isSuccess]);

    if (GetStaffDetail.isLoading) {
        return 'Loading';
    }
    if (GetStaffDetail.isError) {
        return 'Error';
    }
            ...
            <Form>
                ...
                <div className="mb-3">
                    ...
                    <div>
                        ...
                        <Field type="text" placeholder={'Enter Street'} id="address.street"
                               name="address.street"
                               className="form-control"/>
                    ...
                    <div>
                        ...
                        <Field type="text" placeholder={'Enter Country'} id="address.country"
                ...
                <div className="mb-3">
                    ...
                    <Field as="select" placeholder={'Choose Role'} id="role" name="role"
                           className="form-control">
                        <option value="null"/>
