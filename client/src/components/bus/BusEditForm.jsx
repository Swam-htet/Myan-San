...
const BusEditForm = ({id, onSubmitHandler, modelHandler, companyList}) => {
    ...
    let GetBusDetail = useGetBusByID(id);

    useEffect(() => {
        setData(GetBusDetail.data);
    }, [GetBusDetail.isSuccess, GetBusDetail.data]);

    if (GetBusDetail.isLoading) {
        return "Loading";
    }
                    ...
                    >
                        <Form>
                            ...
                            <div className={'mt-2'}>
                                ...
                                <Field type="text" name="make" placeholder="Enter Make"
                                       className={'form-control mb-1'}/>
                            ...
                            <div className={'mt-2'}>
                                ...
                                <Field as="select" name="company" placeholder="Select Company"
                                       className="form-control mb-1">
                            ...
                            <div className={'mt-2'}>
                                ...
                                <Field as="select" name="class" placeholder="Select Bus Class"
                                       className="form-control mb-1">
                                    <option value="" disabled>Select a Company</option>
