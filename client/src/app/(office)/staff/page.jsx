...
export default function StaffListPage() {
  ...
  useEffect(() => {
    ...
    DeleteStaffByIDMutation.data,
    DeleteStaffByIDMutation.isSuccess,
    DeleteStaffByIDMutation.isError,
  ]);
  ...
  return (
    <main>
      ...
      <DeleteConfirmModel
        message={`Do you want to delete staff?`}
        modelHandler={() => {
          setShowDeleteModal(!showDeleteModal);
        }}
        submitHandler={() => {
